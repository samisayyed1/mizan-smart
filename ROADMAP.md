...
- [x] Mizan Connect: Device sync with end-to-end encryption (E2EE)
- [x] Mizan Connect: broker data sync service

**Mizan Connect** is an optional paid subscription to sustain development:
