...
A Mizan addon that helps you visualize your investment progress towards
...
3. Install in Mizan through the addon settings page
...
- Integrate with the Mizan sidebar navigation and routing system
...
MIT License - see the main Mizan project for details.
