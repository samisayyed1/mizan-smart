...
1. Download the addon package from the Mizan addon marketplace
2. Install through the Mizan addon manager
...
- Visit the Mizan community forums
- Submit issues through the addon feedback system
- Check the Mizan documentation for addon troubleshooting
