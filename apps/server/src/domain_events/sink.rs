...
impl WebDomainEventSink {
    ...
    pub fn start_worker(
        ...
        event_bus: EventBus,
        health_service: Arc<dyn mizan_core::health::HealthServiceTrait + Send + Sync>,
        snapshot_service: Arc<
            dyn mizan_core::portfolio::snapshot::SnapshotServiceTrait + Send + Sync,
        >,
        quote_service: Arc<dyn mizan_core::quotes::QuoteServiceTrait + Send + Sync>,
        valuation_service: Arc<
            dyn mizan_core::portfolio::valuation::ValuationServiceTrait + Send + Sync,
        >,
        account_service: Arc<mizan_core::accounts::AccountService>,
        goal_service: Arc<dyn GoalServiceTrait + Send + Sync>,
        fx_service: Arc<dyn mizan_core::fx::FxServiceTrait + Send + Sync>,
