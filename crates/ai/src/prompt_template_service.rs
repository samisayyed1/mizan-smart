...
impl PromptTemplateServiceTrait for PromptTemplateService {
    ...
    fn build_system_prompt(&self, config: &ChatRunConfig) -> Result<String> {
        ...
        let template = self
            ...
            .ok_or_else(|| {
                mizan_core::errors::Error::Validation(
...
pub fn build_run_config_from_context(
    ...
    ChatRunConfig {
        template_id: "mizan-assistant-v1".to_string(),
...
mod tests {
    ...
    const TEST_CATALOG_JSON: &str = r#"{
        ...
        "templates": {
            "mizan-assistant-v1": {
                "id": "mizan-assistant-v1",
                "version": "1.0.0",
                "name": "Mizan Assistant",
                "description": "Default assistant",
                "isDefault": true,
                "sections": {
                    "system": { "content": "You are Mizan Assistant." },
    ...
    fn test_get_default_template() {
        ...
        assert_eq!(template.id, "mizan-assistant-v1");
    }
    ...
    fn test_build_system_prompt() {
        ...
        assert!(prompt.contains("Mizan Assistant"));
