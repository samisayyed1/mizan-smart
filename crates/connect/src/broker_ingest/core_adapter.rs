...
#[async_trait]
impl mizan_core::activities::ImportRunRepositoryTrait for CoreImportRunRepositoryAdapter {
    async fn create(
        &self,
        import_run: mizan_core::activities::ImportRun,
    ) -> mizan_core::errors::Result<mizan_core::activities::ImportRun> {
    ...
    fn get_by_id(
        &self,
        id: &str,
    ) -> mizan_core::errors::Result<Option<mizan_core::activities::ImportRun>> {
    ...
    fn get_recent_for_account(
        ...
        account_id: &str,
        limit: i64,
    ) -> mizan_core::errors::Result<Vec<mizan_core::activities::ImportRun>> {
        self.inner
