//! Mizan Device Sync - Cloud-based device synchronization for Mizan.
//!
//! This crate provides the API client and types for device enrollment, pairing,
//! and E2EE synchronization via the Mizan Connect cloud service.
//!
//! # Usage
//!
//! ```rust,ignore
//! use mizan_device_sync::{DeviceSyncClient, RegisterDeviceRequest, EnrollDeviceResponse};
//!
//! let client = DeviceSyncClient::new("https://api.mizan.app");
