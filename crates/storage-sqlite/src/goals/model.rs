...
impl From<GoalDB> for mizan_core::goals::Goal {
...
impl From<GoalsAllocationDB> for mizan_core::goals::GoalFundingRule {
...
impl From<GoalPlanDB> for mizan_core::goals::GoalPlan {
...
impl From<mizan_core::goals::NewGoal> for NewGoalDB {
    fn from(domain: mizan_core::goals::NewGoal) -> Self {
