...
impl From<HealthIssueDismissalDB> for mizan_core::health::IssueDismissal {
...
impl From<mizan_core::health::IssueDismissal> for HealthIssueDismissalDB {
    fn from(domain: mizan_core::health::IssueDismissal) -> Self {
        Self {
