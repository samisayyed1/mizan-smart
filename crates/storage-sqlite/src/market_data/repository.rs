...
use mizan_core::quotes::store::{ProviderSettingsStore, QuoteStore};
use mizan_core::quotes::types::{AssetId, Day, QuoteSource};
...
impl QuoteStore for MarketDataRepository {
    ...
    fn get_latest_quote(&self, symbol: &str) -> Result<Quote> {
        ...
        match query_result {
            ...
            None => Err(mizan_core::errors::Error::Database(
                mizan_core::errors::DatabaseError::NotFound(format!(
