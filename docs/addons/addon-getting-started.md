...
cd ~/Documents/MizanAddons

# Create addon using CLI
npx @mizan/addon-dev-tools create hello-world-addon
...
```json
{
  ...
  "version": "1.0.0",
  "description": "My first Mizan addon",
  "author": "Your Name",
  "permissions": {
    "category": "ui",
...
function HelloWorldPage() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-4">Hello Mizan</h1>
...
```
Mizan Addon Development Server
...
1. Open Mizan in addon development mode with
   `VITE_ENABLE_ADDON_DEV_MODE=true pnpm tauri dev`
...
import type { AddonContext, Account } from '@mizan/addon-sdk';
...
function HelloWorldPage({ ctx }: { ctx: AddonContext }) {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Hello Mizan</h1>
          ...
          <div>
            ...
            {accounts.length > 0 ? (
              ...
              <p className="text-muted-foreground">
                No accounts found. Add an account in Mizan to see data.
              </p>
            )}
          </div>
        )}
