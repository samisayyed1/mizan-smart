...
and components that integrate directly into Mizan's interface.
...
npm install -D @mizan/addon-dev-tools typescript vite
```

### Core Dependencies

- **@mizan/addon-sdk**: TypeScript types and API definitions
- **@mizan/ui**: UI components based on shadcn/ui and Tailwind CSS
- **@mizan/addon-dev-tools**: CLI and development server
...
Addons have access to Mizan's UI component library:

```typescript
import { Button, Card, Dialog, Input, Table } from '@mizan/ui';
import { AmountDisplay, GainAmount, CurrencyInput } from '@mizan/ui/financial';
...
Mizan Store, contact **support@mizan.app**.
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
  ...
  <Card href="https://github.com/afadil/mizan/tree/main/addons/">
  ...
  <Card href="https://mizan.app/addons">
