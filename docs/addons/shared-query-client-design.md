...
the main Mizan application and addons, enabling automatic cache invalidation and
...
(window as any).__mizan_query_client__ = queryClient;
```
...
```typescript
import { QueryKeys } from "@mizan/addon-sdk";
```
...
components of the Mizan ecosystem.
