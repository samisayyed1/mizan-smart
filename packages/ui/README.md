...
- 💰 **Mizan-specific components** - Financial data display components
...
```tsx
import { Button, Card, CardContent } from "@mizan/ui";
...
```tsx
import { AmountDisplay, GainAmount, GainPercent } from "@mizan/ui";
...
```tsx
// Import components
import { Button, Card, CardContent, AmountDisplay } from "@mizan/ui";

// Import styles (once in your main file)
import "@mizan/ui/styles";
...
All standard shadcn/ui components with Mizan's Flexoki theme applied:
...
3. Customize if needed for Mizan
...
1. Always import from `@mizan/ui` instead of creating custom components
